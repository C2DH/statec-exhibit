...
export const ChapterRouteEmployment = { to: '/employment', label: 'ChapterRouteEmployment', title: 'Emploi et travail', favicon: 'data:image/x-icon;base64,AAABAAEAAQEAAAEAIAAsAAAAFgAAACgAAAABAAAAAgAAAAEAIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACb/f3/AAAAAA==',
  sections: [
